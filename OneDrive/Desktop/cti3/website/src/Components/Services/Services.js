...
Adaptive as Dynamic, networking, cloud-integration, future-ready vehicle software architecture.</div>
   ...
   <div class="card">
     ...
     <article>
       ...
       <div class="desc">Ensures systems operate safely, mitigating risks of hazards or failures.</div>
   ...
   <div class="card">
    ...
    <article>
      ...
      <div class="pic" style={{backgroundColor:' var(--white)', border:' 3px solid #00C2C1'}}><img src={cc} style={{paddingTop: '16px'}}/></div>

      <div class="desc">Integration of vehicles with communication tech for enhanced safety and convenience.</div>
  ...
  <div class="card">
    ...
    <span class="arrow"></span>
    <article>
      <h2>CYBER <br/>SECURITY<br/></h2>
      <div class="pic" style={{backgroundColor:' var(--white)', border:' 3px solid #00C2C1'}}><img src={fs} style={{paddingTop: '16px'}}/></div>

      <div class="desc">Safeguards digital systems, data from unauthorized access, attacks and potential threats or breaches.</div>
