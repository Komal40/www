...
export default function Auto_Details() {
  const arr=[
    ...
    {
      src:nds,
      head:'Networking Stacks',
      para:'Layered protocols enabling communication between devices. They manage tasks like data transmission, routing, and error handling.'
    },
    {
      src:hw,
