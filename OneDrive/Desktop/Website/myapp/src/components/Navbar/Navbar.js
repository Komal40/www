...
export default function Navbar() {
  return (
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info nav" style={{position:'fixed', width:'100vw'
    }}>
    ...
    <a class="navbar-brand" href="#">
      ...
      <div class="collapse navbar-collapse" id="main_nav">
        ...
        <img className='img' src='https://cellustechindia.com/img/skaio_logo.png' alt='logo' style={{marginRight:'1.8rem'}}/>
      </div>
    </div>
  </nav>
